    ...
    <div class="relative w-full max-w-2xl max-h-full mx-auto mt-20">
        <div class="relative bg-white rounded-lg shadow dark:bg-zinc-800">
            ...
            <div class="p-6 space-y-6">
                <form method="POST" action="{{ route('owner.employees.store', $restaurant) }}" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        <label for="password_confirmation" class="block mb-1 font-medium text-zinc-700 dark:text-white">
                            Confirmar Senha *
                        </label>
