            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex space-x-2">
                    <a href="{{ route('promotions.edit', $promotion->id) }}"
                       class="inline-flex items-center p-2 rounded-md text-blue-600 hover:bg-blue-50 dark:text-blue-400 dark:hover:bg-zinc-700" title="Editar">
                    ...
                    <button type="button" data-modal-target="delete-promotion-modal-{{ $promotion->id }}" data-modal-toggle="delete-promotion-modal-{{ $promotion->id }}"
                            class="inline-flex items-center p-2 rounded-md text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-zinc-700" title="Excluir">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
